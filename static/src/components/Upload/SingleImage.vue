      ...
      >
        ...
        <template v-else>
          ...
          <div class="el-upload__text">
            {{ $t('blog.dragImage') }}<em>{{ $t('blog.clickToUpload') }}</em>
          </div>
          <div class="switch-mode">
            <a href="#" @click.stop="changeMode('URL')"><i class="el-icon-arrow-right"/>{{ $t('blog.inputURL') }}</a>
          </div>
        </template>
      </el-upload>
      <div v-else class="image-input">
        <el-input :placeholder="$t('blog.imageURL')" :value="value" @input="emitInput"/>
        <div class="switch-mode">
          <a href="#" @click.stop="changeMode('Upload')"><i class="el-icon-arrow-right"/>{{ $t('blog.dragUpload') }}</a>
        </div>
      </div>
    </template>
  </div>
